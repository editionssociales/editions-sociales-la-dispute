 ...
 *
 * Conservé tel quel (refonte dashboard, issue courante) : encore consommé
 * par `../stock/StockPage.tsx`, hors périmètre de cet agent — la vague 2
 * arbitrera s'il fusionne avec `readStockOutlook` (vélocité) ou reste séparé.
 */
